Rails.application.configure do
  ...
  #need to change back config.consider_all_requests_local       = false
  ...
  config.action_cable.url = "wss://#{ENV['DEFAULT_HOST']}:444/cable"
  config.action_cable.allowed_request_origins = ["https://dev.mybandsource.com"]
  config.action_cable.disable_request_forgery_protection = true
  config.web_socket_server_url = "wss://dev.mybandsource.com:444/cable"
